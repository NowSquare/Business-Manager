            ...
            <tbody>
              <tr>
                <td class="grid-item-card-cell">
                  <img src="{{ url('modules/newsletters/assets/img/image_1-2.png') }}" class="grid-item-image"/>
                  <h1 class="card-title">Title here</h1>
                  <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque enim ligula, interdum sed egestas id, viverra sit amet nisi.</p>
                  <a class="button" style="font-size: 16px;">Learn more</a>
                </td>
              </tr>
            </tbody>
          </table>
