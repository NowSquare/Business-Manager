...
class ProjectAssignedToTask extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
          ...
          ->subject(trans('g.new_task_subject', ['subject' => $this->task->subject]))
          ->markdown('emails.action', [
            ...
            'body_top' => trans('g.task_assigned_mail', ['sender' => $this->sender->name . ' (' . $this->sender->email . ')']),
            'body_footer' => '',
    ...
    public function toArray($notifiable)
    {
        return [
          'type' => 'project-task',
          'title' => trans('g.task_assigned_notification', ['sender' => $this->sender->name, 'subject' => $this->task->subject]),
