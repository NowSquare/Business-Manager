...
class ProjectUpdated extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
          ...
          ->subject(trans('g.project_updated_subject', ['subject' => $this->project->name]))
          ->markdown('emails.action', [
            ...
            'body_top' => trans('g.project_updated_mail', ['sender' => $this->sender->name . ' (' . $this->sender->email . ')']),
            'body_footer' => '',
    ...
    public function toArray($notifiable)
    {
        return [
          'type' => 'project',
          'title' => trans('g.project_updated_notification', ['sender' => $this->sender->name, 'name' => $this->project->name]),
