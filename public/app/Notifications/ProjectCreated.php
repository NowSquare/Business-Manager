...
class ProjectCreated extends Notification
{
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
          ...
          ->subject(trans('g.new_project_subject', ['subject' => $this->project->name]))
          ->markdown('emails.action', [
            ...
            'body_top' => trans('g.project_created_mail', ['sender' => $this->sender->name . ' (' . $this->sender->email . ')']),
            'body_footer' => '',
    ...
    public function toArray($notifiable)
    {
        return [
          'type' => 'project',
          'title' => trans('g.new_project_notification', ['sender' => $this->sender->name, 'name' => $this->project->name]),
