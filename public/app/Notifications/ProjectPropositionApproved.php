...
class ProjectPropositionApproved extends Notification
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        return (new MailMessage)
          ...
          ->subject(trans('g.proposition_approval_subject', ['subject' => $this->project->name]))
          ->markdown('emails.action', [
            ...
            'body_top' => trans('g.proposition_approval_subject_mail', ['sender' => $this->sender->name . ' (' . $this->sender->email . ')']),
            'body_footer' => '',
    ...
    public function toArray($notifiable)
    {
        return [
          ...
          'title' => trans('g.project_proposition_approved_notification', ['sender' => $this->sender->name, 'name' => $this->project->name]),
