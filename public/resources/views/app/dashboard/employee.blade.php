              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="m-0"><a href="{{ url('notifications') }}">{{ auth()->user()->notifications->count() }} <small>{{ trans('g.notifications') }}</small></a></h4>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="m-0"><a href="{{ url('companies') }}">{{ $client_companies->where('active', 1)->count() }} <small>{{ trans('g.clients') }}</small></a></h4>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="m-0"><a href="{{ url('projects') }}">{{ $projects->where('completed_date', null)->count() }} <small>{{ trans('g.projects') }}</small></a></h4>
              ...
              <div class="col-sm-6 col-lg-3">
                <div class="card p-3">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      <h4 class="m-0"><a href="{{ url('projects') }}">{{ $tasks_count }} <small>{{ trans('g.tasks') }}</small></a></h4>
