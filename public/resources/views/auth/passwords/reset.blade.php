      ...
      <form class="card" action="{{ url('password/reset') }}" method="post">
        ...
        <div class="card-body p-6">
          ...
          <div class="form-group">
            ...
            <input type="email" class="form-control" placeholder="{{ trans('g.enter_email') }}" name="email" value="{{ old('email', $email) }}" required>
          ...
          <div class="form-group">
            <label class="form-label">{{ trans('g.new_password') }}</label>
            <input type="password" class="form-control" placeholder="{{ trans('g.password') }}" name="password" required>
          </div>

          <div class="form-group">
            <label class="form-label">{{ trans('g.confirm_password') }}</label>
            <input type="password" class="form-control" placeholder="{{ trans('g.password') }}" name="password_confirmation" required>
